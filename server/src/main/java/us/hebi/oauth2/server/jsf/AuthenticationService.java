...
class AuthenticationService {
    ...
    boolean requireUserAuthentication(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        if (!isAuthenticated) {
            ...
            res.sendRedirect(service.getAuthorizationUrl(additionalParams));
    ...
    void handleAuthenticationCallback(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        asyncCtx.start(() -> {
            ...
            try {
                ...
                // Get user info
                OAuthRequest oReq = new OAuthRequest(Verb.GET, infoEndpoint);
    ...
    static final String CALLBACK_URI = "/oauth2callback";
    ...
    private static final String infoEndpoint = "https://www.googleapis.com/plus/v1/people/me";

    private static final Map<String, String> additionalParams = new HashMap<>();
